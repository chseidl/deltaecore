package org.deltaecore.common.eclipse.controls;
...
public class DEVariantComposite extends SelectSingleFolderComposite {
	public DEVariantComposite(Composite parent, int style) {
		super(parent, style);
